...
export class MisTurnosComponent {
  ...
  ngOnInit(): void {
    ...
    this.firestoreService.traerEspecialistas().subscribe((users:any) => {
      this.spinner = false;
      if (users) {
  ...
  confirmarCancelacion(turno: any) {
    if (this.comentarioCancelacion == '') {
      ...
      setTimeout(() => {
        ...
        this.confirmacionFinalizacion = false;
        this.notificationService.showSuccessAlert('Se cancelo el turno correctamente', 'Turnos', 'success');
      }, 1000);
    }
  }
  ...
  aceptarTurno(turno: any) {
    ...
    setTimeout(() => {
      ...
      this.confirmacionRechazo = false;
      this.confirmacionFinalizacion = false;
      this.notificationService.showSuccessAlert('Turno aceptado exitosamente', 'Turnos', 'success');
    }, 1000);
  }
  ...
  confirmarFinalizacion(turno: any) {
    ...
    setTimeout(() => {
      ...
      this.confirmacionRechazo = false;
      this.confirmacionFinalizacion = false;
      this.notificationService.showSuccessAlert('Turno Finalizado correctamente', 'Turnos', 'success');
    }, 1000);
  }
