...
export class SolicitarTurnoComponent {
  ...
  ngOnInit(): void {
    ...
    this.authService.user$.subscribe((user: any) => {
      if (user) {
        this.spinner = false;
        this.user = user;
        if (this.authService.perfilDelUsuario=="administrador") {
  ...
  seleccionarTurno(turno: any) {
    ...
    this.notificationService.showSuccessAlert('Cuidado! Selecciono el turno: '+turno.fecha, 'Turno seleccionado', 'warning');
  }
